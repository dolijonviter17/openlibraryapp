...
const DetailBookScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.flex}>
      <HeaderComponent title="Detail Book" onPress={handleBack} />
      <ScrollView
        style={{
      ...
      >
        ...
        >
          ...
          />
          <Text style={styles.textCreateInput}>{inputBook.name}</Text>
          <Text style={styles.textCreateInput}>{inputBook.seed_count}</Text>

          <Text style={styles.textCreateInput}>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cumque
            architecto fuga, consectetur nostrum ad autem temporibus minima
            excepturi in dignissimos tempore, totam iste minus ex qui optio,
            harum quas nulla?
          </Text>
        </View>
      </ScrollView>
